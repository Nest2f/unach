...
session_start();
    ...
    if ($identificador['Id_Tipo_Usuario'] != 2) {
...
/*		background-color: #CED8F6;*/
    ...
    <body>
        ...
        <div class="container">
            <header>
                <br>
                <h1> Bienvenid@ <span> &quot;<?php echo ' '.$row['Us_Nombres'].' '.$row['Us_Apellidos']; ?>&quot; </span></h1>
            </header>
            <input hidden='true' type='text' name='Idh' value=<?php echo $row['Us_Cedula']; ?> />
                <div id="container_demo" >
                    ...
                    <div class="box-1 border-right">
                        <a href="modificar_secretaria.php" style="border-style: none;box-shadow: none;"> <img src="../imagenes/perfil.png" width="65" height="65" > </a>
