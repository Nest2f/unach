...
$query4 = "select * from emisor_documento";
$re5 = mysqli_query($conex, $query4);
$query5 = "select *from usuario where Us_Cedula=$cedula;";
$re4 = mysqli_query($conex, $query5);
                                ...
                                <p> 
                                    ...
                                    <select  for="emailsignup" name="emisor" >
                                        ...
                                        <?php while ($row = mysqli_fetch_array($re5)) {
                                            ?>
                                            <option  value="<?php echo $row['Id_Emisor'] ?>"> <?php echo htmlentities($row['Descripcion_Emisor']);
                                    } ?> </option>
                                ...
                                <p> 
                                    ...
                                    <select  for="emailsignup" name="estadodedocumento" >
                                        ...
                                        <?php while ($row = mysqli_fetch_array($res)) {
                                            ?>
                                            <option  value="<?php echo $row['Id_Estado_Documento'] ?>"> <?php echo htmlentities($row['Nombre_Estado_Documento']);
                                        } ?> </option>
