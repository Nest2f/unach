...
<html>
    ...
    <body>
        ...
        <div id="container_demo" >
            <div id="wrapper">
                <form  name="datos" method="REQUEST"  action="mod_docente.php" onsubmit="return validar(this)" enctype="multipart/form-data">
                    ...
                    <table><tr><td id="td_1">
                                ...
                                <p> 
                                    <label for="cedulainicio" class="uname" data-icon="#" > Cedula </label>
                                ...
                                <p> 
                                    <label for="telefonoinicio" class="uname" data-icon="#" > Teléfono </label>
                                ...
                                <p> 
                                    ...
                                    <input name="tipo_usuario" type="text" placeholder="ejm: Av....." disabled="true" value="<?php echo $row['Descripcion_T']; ?>" />
                                </p>
                                <p> 
                                ...
                                <p> 
                                    ...
                                    <select for="emailsignup" name="departamento">                                        
